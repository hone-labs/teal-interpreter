...
export const opcodeDefs: IOpcodeMap = {
    ...
    "b|":  {
        ...
        stack: 2,
        cost: 6,
        factory: function (token) { return new ByteOr(token, this) },
    },        
    "b&":  {
        version: 4,
        operands: 0,
        stack: 2,
        cost: 6,
        factory: function (token) { return new ByteAnd(token, this) },
    },        
    "b^":  {
        version: 4,
        operands: 0,
        stack: 2,
        cost: 6,
        factory: function (token) { return new ByteXor(token, this) },
    },        
    "b~":  {
        version: 4,
        operands: 0,
